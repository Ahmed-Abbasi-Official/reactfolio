        ...
        <>
            ...
            <div className='row py-4'>
                ...
                <div className="col-lg-6 col-md-12 col-12 d-flex justify-content-center align-items-center">
                    <div className='d-flex flex-column justify-content-center  skillsIconDiv'>
                        ...
                        <div className="skillIconsDiv">
                            <motion.ul
                                className='iconsList d-flex  justify-content-center item flex-wrap'
                                initial={{ opacity: 0, x: 75 }}
                                whileInView={{ opacity: 1, x: 0 }}
                                viewport={{ once: true }}
                                transition={{ duration: 1 }}
                        ...
                        <About/>
                        <div className="skillsListDiv main">
                            {
                                skillsList.map((v, i) => {
                                    return (
                                        <motion.div
