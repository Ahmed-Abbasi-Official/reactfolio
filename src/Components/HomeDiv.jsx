      ...
      <div className="row px-4 py-5">
        <div className="col-lg-6 col-md-12 col-12 d-flex flex-column justify-content-center align-items-center">
          ...
          >
            ...
            <TypeAnimation
    sequence={[
        'Mechanical Engineering Student at NUST',
        2000,
        'Certified in ANSYS & SolidWorks',
        2000,
        'Aspiring CFD Analyst',
        2000,
        'Intern at Atlas Honda Pvt.',
        2000,
        'Intern at Volvo Private Limited',
        2000,
    ]}
    repeat={Infinity}
/>
          ...
          <motion.h4
            ...
            transition={{ duration: 1 }}
          >
            Transforming Concepts into Functional Projects
          </motion.h4>
